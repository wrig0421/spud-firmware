...
{
	LED_STATE_FIRST = 0,
	LED_STATE_SPELL = LED_STATE_FIRST, // 0x4B0, 0x11f8
	//LED_STATE_MINT_NOHBZ,
	LED_STATE_WHITE_COLOR,
	LED_STATE_SOLID_COLOR,
	LED_STATE_SPARKLE_NO_FILL, // 0x9d8, 0x5064
    LED_STATE_SPARKLE_FILL,
    LED_STATE_RAINBOW_CYCLE, // 0x4600, 0x8700
    LED_STATE_THEATER_CHASE, // 0xf3b, 0x1d4c
    LED_STATE_THEATER_CHASE_RAINBOW, // 0x2700, 0x4e00
    LED_STATE_FADE_IN_AND_OUT, // 0x1381, 0x2700
    LED_STATE_TWINKLE, // 0xd98, 0x341c
	LED_STATE_TWO_COLOR,
