...
sdk/STM32L4xx_HAL_Driver/Src/%.o sdk/STM32L4xx_HAL_Driver/Src/%.su sdk/STM32L4xx_HAL_Driver/Src/%.cyclo: ../sdk/STM32L4xx_HAL_Driver/Src/%.c sdk/STM32L4xx_HAL_Driver/Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32L431xx -c -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" @"sdk/STM32L4xx_HAL_Driver/Src/stm32l4xx_hal.c_includes.args"
