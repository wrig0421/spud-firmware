...
clean-src:
	-$(RM) ./src/flash_access.cyclo ./src/flash_access.d ./src/flash_access.o ./src/flash_access.su ./src/flash_info.cyclo ./src/flash_info.d ./src/flash_info.o ./src/flash_info.su ./src/main.cyclo ./src/main.d ./src/main.o ./src/main.su ./src/numbers.cyclo ./src/numbers.d ./src/numbers.o ./src/numbers.su ./src/task_create.cyclo ./src/task_create.d ./src/task_create.o ./src/task_create.su ./src/task_dma_transfer.cyclo ./src/task_dma_transfer.d ./src/task_dma_transfer.o ./src/task_dma_transfer.su ./src/version.cyclo ./src/version.d ./src/version.o ./src/version.su
