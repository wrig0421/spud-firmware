...
C_SRCS += \
../src/bsp/peripheral/uart/uart_access_hal.c 

OBJS += \
./src/bsp/peripheral/uart/uart_access_hal.o 

C_DEPS += \
./src/bsp/peripheral/uart/uart_access_hal.d 


# Each subdirectory must supply rules for building sources it contributes
src/bsp/peripheral/uart/%.o src/bsp/peripheral/uart/%.su src/bsp/peripheral/uart/%.cyclo: ../src/bsp/peripheral/uart/%.c src/bsp/peripheral/uart/subdir.mk
...
clean: clean-src-2f-bsp-2f-peripheral-2f-uart

clean-src-2f-bsp-2f-peripheral-2f-uart:
	-$(RM) ./src/bsp/peripheral/uart/uart_access_hal.cyclo ./src/bsp/peripheral/uart/uart_access_hal.d ./src/bsp/peripheral/uart/uart_access_hal.o ./src/bsp/peripheral/uart/uart_access_hal.su

.PHONY: clean-src-2f-bsp-2f-peripheral-2f-uart
