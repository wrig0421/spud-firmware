...
../src/bsp/spi_access.c \
../src/bsp/uart_access.c 

OBJS += \
./src/bsp/board_init_common.o \
./src/bsp/spi_access.o \
./src/bsp/uart_access.o 

C_DEPS += \
./src/bsp/board_init_common.d \
./src/bsp/spi_access.d \
./src/bsp/uart_access.d 
...
clean-src-2f-bsp:
	-$(RM) ./src/bsp/board_init_common.cyclo ./src/bsp/board_init_common.d ./src/bsp/board_init_common.o ./src/bsp/board_init_common.su ./src/bsp/spi_access.cyclo ./src/bsp/spi_access.d ./src/bsp/spi_access.o ./src/bsp/spi_access.su ./src/bsp/uart_access.cyclo ./src/bsp/uart_access.d ./src/bsp/uart_access.o ./src/bsp/uart_access.su
