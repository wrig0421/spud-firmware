...
{
    bool return_val = true;
    return_val &= gpio_config_green_led_on();
    return_val &= gpio_config_red_led_on();
    return return_val;
}
...
void gpio_config_esp8266_deselect_chip(void)
{
    HAL_GPIO_WritePin(gpio_config[GPIO_CONFIG_PIOA_PIN4].port, gpio_config[GPIO_CONFIG_PIOA_PIN4].pin, GPIO_PIN_SET);
}


void gpio_config_esp8266_select_chip(void)
{
    HAL_GPIO_WritePin(gpio_config[GPIO_CONFIG_PIOA_PIN4].port, gpio_config[GPIO_CONFIG_PIOA_PIN4].pin, GPIO_PIN_RESET);
}

void gpio_config_esp8266_en(void)
{
    HAL_GPIO_WritePin(gpio_config[GPIO_CONFIG_PIOA_PIN6].port, gpio_config[GPIO_CONFIG_PIOA_PIN6].pin, GPIO_PIN_SET);
    HAL_GPIO_WritePin(gpio_config[GPIO_CONFIG_PIOA_PIN7].port, gpio_config[GPIO_CONFIG_PIOA_PIN7].pin, GPIO_PIN_SET);
}
