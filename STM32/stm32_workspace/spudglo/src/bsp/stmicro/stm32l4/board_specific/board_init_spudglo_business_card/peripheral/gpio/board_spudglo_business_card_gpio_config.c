...
const gpio_config_t g_gpio_config[NUM_GPIO_PINS] =
{
	...
	[GPIO_PIOC_PIN_1] =
	{
		.pin = GPIO_PIOC_PIN_1,
		.port = GPIO_PORT_C,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN // LPUART1
	},
	[GPIO_PIOC_PIN_2] =
	{
		.pin = GPIO_PIOC_PIN_2,
	...
	[GPIO_PIOA_PIN_10] =
	{
		.pin = GPIO_PIOA_PIN_10,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_ALTERNATE_FUNCTION
	},
	[GPIO_PIOA_PIN_11] =
	{
		.pin = GPIO_PIOA_PIN_11,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_ALTERNATE_FUNCTION // SPI1
	},
	[GPIO_PIOA_PIN_12] =
	{
		.pin = GPIO_PIOA_PIN_12,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_ALTERNATE_FUNCTION // SPI1
	},
	...
	[GPIO_PIOB_PIN_10] = // NC
	{
		...
		.port = GPIO_PORT_B,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN // I2C2
	},
	[GPIO_PIOB_PIN_11] = // NC
	{
	...
	[GPIO_PIOB_PIN_12] = // XR_GPIO
	{
		.pin = GPIO_PIOB_PIN_12,
		.port = GPIO_PORT_B,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN
	},
	[GPIO_PIOB_PIN_13] = // VBUS_PRESENT
	{
