...
typedef enum
{
	BUTTON_IRQ_A = EXTI0_IRQn,
	BUTTON_IRQ_B = EXTI15_10_IRQn,
	BUTTON_IRQ_C = EXTI9_5_IRQn,
...
typedef enum
{
	BUTTON_PIN_A = GPIO_PIN_0, 		// PA0
	BUTTON_PIN_B = GPIO_PIN_13,		// PC13
	BUTTON_PIN_C = GPIO_PIN_5,		// PC5
	BUTTON_PIN_D = GPIO_PIN_2		// PA2
} button_pin_e;
