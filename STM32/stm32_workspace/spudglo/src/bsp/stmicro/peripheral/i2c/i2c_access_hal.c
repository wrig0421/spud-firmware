...
{
	i2c_handle_t i2c_handle = i2c_config_chip_id_to_bus_handle(i2c_chip_info->chip_address);
	HAL_I2C_Mem_Write(i2c_handle, i2c_chip_info->chip_address, i2c_chip_info->chip_memory_address,
...
{
	i2c_handle_t i2c_handle = i2c_config_chip_id_to_bus_handle(i2c_chip_info->chip_address);
	HAL_I2C_Mem_Read(i2c_handle, i2c_chip_info->chip_address, i2c_chip_info->chip_memory_address,
						i2c_chip_info->chip_memory_address_width_bytes, i2c_chip_info->tx_rx_buffer,
						i2c_chip_info->num_byte_to_tx_rx, I2C_DEFAULT_TIMEOUT_MS);
}
