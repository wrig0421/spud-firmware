...
typedef enum
{
	UART_CONFIG_BUS_FIRST,
	UART_CONFIG_BUS_INSTANCE_1 = UART_CONFIG_BUS_FIRST,
	UART_CONFIG_BUS_INSTANCE_2,
	UART_CONFIG_BUS_INSTANCE_3,
	LPUART_CONFIG_BUS_INSTANCE_1,
	NUM_UART_CONFIG_BUSES,
	UART_CONFIG_BUS_HOST = LPUART_CONFIG_BUS_INSTANCE_1,
	UART_CONFIG_BUS_ESP8266 = UART_CONFIG_BUS_INSTANCE_1,
