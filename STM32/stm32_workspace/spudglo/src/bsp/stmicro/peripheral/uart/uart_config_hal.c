...
//    	    	    gh_dma_lpuart1_rx.Init.Direction = DMA_PERIPH_TO_MEMORY; // take from uart periph to memory
...
//    	    	    UART_ITConfig(LPUART1, UART_IT_TXE, ENABLE);
//    	    	    UART_ITConfig(LPUART1, UART_IT_RXNE, ENABLE);
				break;
//    	    	case :
