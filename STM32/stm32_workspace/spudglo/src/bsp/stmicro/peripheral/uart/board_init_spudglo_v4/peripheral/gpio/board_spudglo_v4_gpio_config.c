...
const gpio_config_t g_gpio_config[NUM_GPIO_PINS] =
{
	...
	[GPIO_PIOC_PIN_14] = // OSCILLATOR!!!
	{
		.pin = GPIO_PIOC_PIN_14,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_NO_SETTING
	},
	[GPIO_PIOC_PIN_15] = // OSCILLATOR!!!!
	{
		.pin = GPIO_PIOC_PIN_6,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_NO_SETTING
	...
	[GPIO_PIOA_PIN_5] =
	{
		.pin = GPIO_PIN_DISP_BACKLIGHT,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN
	},
	[GPIO_PIOA_PIN_6] =
	{
		.pin = GPIO_PIN_DISP_DC,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_OUTPUT_PUSHPULL,
	...
	[GPIO_PIOA_PIN_11] =
	{
		.pin = GPIO_PIN_SPI1_CIPO,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_ALTERNATE_FUNCTION
	},
	[GPIO_PIOA_PIN_12] =
	{
		.pin = GPIO_PIN_SPI1_COPI,
		.port = GPIO_PORT_A,
		.mode = GPIO_CONFIG_MODE_ALTERNATE_FUNCTION
	},
	...
	[GPIO_PIOB_PIN_8] = // NC
	{
		.pin = GPIO_PIOB_PIN_BLUE_LED,
		.port = GPIO_PORT_B,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN
	},
	[GPIO_PIOB_PIN_9] = // NC
	{
		.pin = GPIO_PIOB_PIN_ORANGE_LED,
		.port = GPIO_PORT_B,
		.mode = GPIO_CONFIG_MODE_INPUT_PULLDOWN
	},
	[GPIO_PIOB_PIN_10] = // NC
