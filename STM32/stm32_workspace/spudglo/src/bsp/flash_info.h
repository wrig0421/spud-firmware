...
#define FLASH_SUB_BLOCK_CONFIG_PAGE_START			(FLASH_MAX_PAGE_NUMBER - 3)
#define FLASH_SUB_BLOCK_STATUS_PAGE_START			(FLASH_MAX_PAGE_NUMBER - 2)
#define FLASH_SUB_BLOCK_IMAGE_PAGE_START			(FLASH_MAX_PAGE_NUMBER - 1)
