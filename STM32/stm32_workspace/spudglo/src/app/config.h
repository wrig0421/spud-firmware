...
#   define BOARD_SUPPORTS_UART
#	define BOARD_SUPPORTS_TIMER
#elif defined(BOARD_SPUDGLO_MINI_V1P0)
#	define BOARD_SPUDGLO_MINI_V1
#   define BOARD_SUPPORTS_UART
#	define BOARD_SUPPORTS_TIMER
...
#	error "BOARD_SPUDGLO_V8P0 has HW issues.  Not for use!  Please define another board!"
#endif

#if (NUM_ACTIVE_STRIPS > 1)
//#	define ENABLE_LED_STATE_TWO_COLOR
//#	define ENABLE_LED_STATE_STATIC_AND_RAINBOW_CHASE
#endif
