...
//
        ...
        //HAL_TIM_PWM_Start_DMA(&g_tim1_handle, TIM_CHANNEL_2, (uint32_t *)(gp_pwm_data_fill + (offset * BITS_PER_BYTE * sizeof(ws2812b_led_t)) + (STRIP_NUM_1 * (uint32_t)WS2812B_BIT_RESET_CYCLES)), (STRIP_1_LENGTH * BITS_PER_BYTE * sizeof(ws2812b_led_t)) + WS2812B_RESET_TIME_CYCLES);
...
//        }
//#if defined(STRIP_1_LENGTH)
//        else if (dma_transfer_state & TASK_DMA_TRANSFER_STATE_TIM1_CHANNEL_1)
//        {
//            offset = ws2812_get_pwm_strip_offset(STRIP_BIT_1);
//            HAL_TIM_PWM_Start_DMA(&g_tim1_handle, TIM_CHANNEL_2, (uint32_t *)(gp_pwm_data_fill + (offset * BITS_PER_BYTE * sizeof(ws2812b_led_t)) + (STRIP_NUM_1 * (uint32_t)WS2812B_BIT_RESET_CYCLES)), (STRIP_1_LENGTH * BITS_PER_BYTE * sizeof(ws2812b_led_t)) + WS2812B_RESET_TIME_CYCLES);
...
//#endif
//#if defined(STRIP_2_LENGTH)
//        else if (dma_transfer_state & TASK_DMA_TRANSFER_STATE_TIM1_CHANNEL_2)
//        {
//            offset = ws2812_get_pwm_strip_offset(STRIP_BIT_2);
...
//#endif
//#if defined(STRIP_3_LENGTH)
//        else if (dma_transfer_state & TASK_DMA_TRANSFER_STATE_TIM1_CHANNEL_3)
//        {
//            offset = ws2812_get_pwm_strip_offset(STRIP_BIT_3);
...
//#endif
//#if defined(STRIP_4_LENGTH)
//        else if (dma_transfer_state & TASK_DMA_TRANSFER_STATE_TIM15_CHANNEL_1)
//        {
//            offset = ws2812_get_pwm_strip_offset(STRIP_BIT_4);
...
//#endif
//#if defined(STRIP_5_LENGTH)
//        else if (dma_transfer_state & TASK_DMA_TRANSFER_STATE_TIM16_CHANNEL_1)
//        {
//            offset = ws2812_get_pwm_strip_offset(STRIP_BIT_5);
